...
-- VALUES 
-- ("9", "2024-09-17 12:01:00", "11", "What is the name of the notorious serial killer who terrorized London in 1888?", "Jack the Ripper", "Correct! Jack the Ripper is one of history's most infamous killers, and his identity remains a mystery to this day.", "10", "3"),
-- ("10", "2024-09-17 12:02:00", "12", "Which pub, associated with two of Jack the Ripper's victims, still stands today in Spitalfields?", "The Ten Bells", "Exactly! The Ten Bells is a historic pub tied to the victims of Jack the Ripper, offering both mystery and a pint of ale.", "15", "3"),
-- ("11", "2024-09-17 12:03:00", "13", "What is the name of the iconic church near where some of the Ripper’s victims were found?", "Christ Church Spitalfields", "Correct! Christ Church Spitalfields is a prominent landmark in the Ripper tour, and its surrounding areas were key in the 1888 murders.", "15", "3"),
-- ("12", "2024-09-17 12:04:00", "14", "Which pub on Whitechapel High Street is rumored to have once been a haunt of the Ripper?", "The White Hart", "Yes! The White Hart is a historic pub believed to have been frequented by none other than Jack the Ripper himself.", "10", "3"),
-- ("13", "2024-09-17 12:05:00", "15", "Which underground station is closest to one of the key Ripper sites and offers easy access to other East End locations?", "Aldgate East", "Absolutely! Aldgate East is a major stop on the Ripper tour, providing access to various pubs and historic sites.", "10", "3"),
-- ("14", "2024-09-17 12:06:00", "16", "Which East End pub, famous for more than just the Ripper, is also known for its association with notorious gangster Ronnie Kray?", "The Blind Beggar", "Correct! The Blind Beggar is a historic pub with a darker side, tied not only to Jack the Ripper but also to London's gangster history.", "15", "3");
